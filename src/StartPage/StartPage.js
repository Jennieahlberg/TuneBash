      ...
      <div>
        ...
        <div className="codeInput">
          <form onSubmit={this.submitDataHandler}>
            <input type="text" value={this.state.gameId} onChange={(event) => this.setState({ gameId: event.target.value })} placeholder="Pinkod" />
            <input type="text" value={this.state.name} onChange={(event) => this.setState({ name: event.target.value })} placeholder="Namn"  />
