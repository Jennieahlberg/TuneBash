...
const startPage = (props) => {
    return <div className="body">
        ...
        <div className="codeInput">
            ...
            <button className="playButton" onClick={props.onClick}>Let's rock!</button>
        </div>
        <div className="newGame">
            <button id="newGameButton" onClick={props.onClickNew}>Generera nytt spel</button>
        </div>
    </div>
}
